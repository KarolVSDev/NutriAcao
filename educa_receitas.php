...
<div class='buttons'>
    <a class="btn btn-primary" href="educa_noticias.php" role="button">Notícias</a>
    <a class="btn btn-primary" href="educa_receitas.php" role="button">Receitas</a>
    <a class="btn btn-primary" href="educa_dicas.php" role="button">Dicas</a>
    <br>
    <br>
  </div>
<br>
